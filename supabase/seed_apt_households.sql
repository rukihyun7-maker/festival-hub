...
update public.local_info set data = data || '{"households":126}'::jsonb where category='apartment' and external_id='kakao-717524360';
...
update public.local_info set data = data || '{"households":598}'::jsonb where category='apartment' and external_id='kakao-11344841';
update public.local_info set data = data || '{"households":680}'::jsonb where category='apartment' and external_id='kakao-11348773';
update public.local_info set data = data || '{"households":137}'::jsonb where category='apartment' and external_id='kakao-11083263';
update public.local_info set data = data || '{"households":272}'::jsonb where category='apartment' and external_id='kakao-11364547';
...
update public.local_info set data = data || '{"households":423}'::jsonb where category='apartment' and external_id='kakao-26824343';
...
update public.local_info set data = data || '{"households":126}'::jsonb where category='apartment' and external_id='kakao-8867859';
...
update public.local_info set data = data || '{"households":170}'::jsonb where category='apartment' and external_id='kakao-27205544';
update public.local_info set data = data || '{"households":156}'::jsonb where category='apartment' and external_id='kakao-2011246935';
update public.local_info set data = data || '{"households":310}'::jsonb where category='apartment' and external_id='kakao-1799115118';
update public.local_info set data = data || '{"households":123}'::jsonb where category='apartment' and external_id='kakao-23987991';
...
update public.local_info set data = data || '{"households":464}'::jsonb where category='apartment' and external_id='kakao-11189077';
update public.local_info set data = data || '{"households":69}'::jsonb where category='apartment' and external_id='kakao-11375951';
...
update public.local_info set data = data || '{"households":122}'::jsonb where category='apartment' and external_id='kakao-11347308';
...
update public.local_info set data = data || '{"households":392}'::jsonb where category='apartment' and external_id='kakao-11816816';
update public.local_info set data = data || '{"households":298}'::jsonb where category='apartment' and external_id='kakao-19494594';
update public.local_info set data = data || '{"households":165}'::jsonb where category='apartment' and external_id='kakao-10166857';
update public.local_info set data = data || '{"households":375}'::jsonb where category='apartment' and external_id='kakao-8682620';
...
update public.local_info set data = data || '{"households":298}'::jsonb where category='apartment' and external_id='kakao-7854979';
update public.local_info set data = data || '{"households":273}'::jsonb where category='apartment' and external_id='kakao-8161787';
update public.local_info set data = data || '{"households":130}'::jsonb where category='apartment' and external_id='kakao-27070028';
update public.local_info set data = data || '{"households":182}'::jsonb where category='apartment' and external_id='kakao-11193215';
...
update public.local_info set data = data || '{"households":108}'::jsonb where category='apartment' and external_id='kakao-26927890';
update public.local_info set data = data || '{"households":288}'::jsonb where category='apartment' and external_id='kakao-26546730';
...
update public.local_info set data = data || '{"households":461}'::jsonb where category='apartment' and external_id='kakao-1998706687';
update public.local_info set data = data || '{"households":891}'::jsonb where category='apartment' and external_id='kakao-11353445';
...
update public.local_info set data = data || '{"households":136}'::jsonb where category='apartment' and external_id='kakao-11346027';
update public.local_info set data = data || '{"households":120}'::jsonb where category='apartment' and external_id='kakao-11254479';
...
update public.local_info set data = data || '{"households":315}'::jsonb where category='apartment' and external_id='kakao-27564987';
...
update public.local_info set data = data || '{"households":298}'::jsonb where category='apartment' and external_id='kakao-19121486';
update public.local_info set data = data || '{"households":150}'::jsonb where category='apartment' and external_id='kakao-12754091';
update public.local_info set data = data || '{"households":120}'::jsonb where category='apartment' and external_id='kakao-12754092';
update public.local_info set data = data || '{"households":90}'::jsonb where category='apartment' and external_id='kakao-19146410';
update public.local_info set data = data || '{"households":142}'::jsonb where category='apartment' and external_id='kakao-10882899';
update public.local_info set data = data || '{"households":614}'::jsonb where category='apartment' and external_id='kakao-1135369943';
update public.local_info set data = data || '{"households":98}'::jsonb where category='apartment' and external_id='kakao-12784741';
update public.local_info set data = data || '{"households":98}'::jsonb where category='apartment' and external_id='kakao-11167808';
