    ...
    <main className="min-h-screen bg-page">
      <div className="container-app py-10 max-w-[820px]">
        ...
        <div className="card space-y-5 text-[13.5px] leading-[1.75] text-text-secondary">
          ...
          <Section n="제5조의2 (신청 취소·위약 및 정산)">
            ① 입점 파트너의 신청이 행사 주최에 의해 확정된 후 파트너의 사정으로 취소하는 경우, 각 행사에 고지된 취소 정책에 따라 위약금(예: 참가비의 30%)이 발생할 수 있습니다.<br />
            ② <b>참가비·정산·취소·위약에 관한 사항은 행사 주최와 입점 파트너 간의 약정에 따르며, 서비스는 이를 중개·안내할 뿐 거래 당사자가 아닙니다.</b><br />
            ③ 참가비 결제·정산은 원칙적으로 서비스 외부에서 당사자 간 직접 이루어지며, 이에 따른 분쟁의 책임은 각 당사자가 부담합니다.
          </Section>
